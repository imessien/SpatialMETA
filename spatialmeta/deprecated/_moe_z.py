...
from ..model._model import ConditionalVAE
...
class ConditionalVAEMOE(ConditionalVAE):
    ...
    def fit(
            ...
            **kwargs
            ...
            if mode == 'single':
                ...
                kwargs['kl_weight_st'] = 0.5
                kwargs['kl_weight_sm'] = 0.5
                ...
                kwargs['kl_weight_st'] = 1
                kwargs['kl_weight_sm'] = 1
                kwargs['kl_weight'] = 1
    ...
    def fit_core(self,
            ...
            kl_weight: float = 2.,
            kl_weight_st: float = 1.,
            kl_weight_sm: float = 1.,
    ...
    def get_modality_contribution(
        ...
        joint_latent, st_latent, sm_latent = self.get_latent_embedding(
